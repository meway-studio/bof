		...
		<div class="personal">
			...
			<div class="information">
				...
				<?php $form=$this->beginWidget('CActiveForm', array(
					...
					<label style="margin-left:30px;"><?php echo $form->checkBox($model,'fast_notice'); ?><?php echo Yii::t('user', 'Получать каждый новый совет по электронной почте');?></label>
