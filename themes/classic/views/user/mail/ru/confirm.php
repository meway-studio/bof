...
<body style="margin: 0px; padding: 0px;background-color: #f5f7fa;">
	<div style="width: 100%;margin: 0;padding: 0;font-family: Arial,sans-serif;color: #ffffff;background-color: #f5f7fa;">
		...
		<table width="654" style="display: block;margin: 0 auto;color: #434a54;background-color: #fff;border-style: solid; border-color: #e6e9ed; border-width: 1px 1px 2px 1px;">
			<tr>
				<td style="font-size: 13px;padding: 40px 30px;color: #000;">
					<div style="font-size: 34px;font-weight: bold;">Welcome to the team BetOnFootball!</div>
					<br/>
					<div style="font-size: 18px;color: #434a54;">
						Hello, <?php echo $model->FullName;?>!<br/>
						We are glad to see you on BetOnFootball.<br /><br />
						Subscribe any convenient time and get the opportunity to view all the paid and free predictions/previews directly on our website betonfootball.eu. You can also buy any tip separately. We are a team of professional football analysts with the experience of more than 14 years and our main task is to provide you on a regular basis with betting information, so that you can easily earn money. If you have any questions, please contact us.
					</div>

				</td>
			</tr>
		</table>
		<table width="660" height="135" style="display: block;margin: 30px auto 0px auto;color: #434a54;background: url(<?php echo Yii::app()->createAbsoluteUrl('/'); ?>/images/mail/mail_account.jpg) center left no-repeat;">
			<tr>
				<td style="font-size: 18px;color: #4fc1e9;text-transform: uppercase;">
					<div style="margin: 29px 0px 0px 31px;">Your access to account:</div>
				</td>
			</tr>
			<tr>
				<td width="660" style="font-size: 18px;color: #fff;">
					<div style="margin: 29px 0px 0px 76px;float: left;"><?php echo $model->email;?></div>
					<div style="margin: 29px 31px 0px 0px; float: right; width: 240px;"><?php echo $model->temp_password;?></div>
				</td>
			</tr>
		</table>
		<table width="654" style="display: block;margin: 30px auto;color: #656d78;background-color: #454C58;border-style: solid; border-color: #e6e9ed; border-width: 1px 1px 2px 1px;">
			<tr>
				<td style="font-size: 13px;padding: 40px 30px;color: #000;">
					<div style="color: #fff; font-size: 24px;">Subscriptions</div>
