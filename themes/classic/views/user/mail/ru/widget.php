	...
	<div style="width: 100%;margin: 0;padding: 0;font-family: Arial,sans-serif;color: #ffffff;background-color: #f5f7fa;">
		...
		<table width="654" style="display: block;margin: 0 auto;color: #434a54;background-color: #fff;border-style: solid; border-color: #e6e9ed; border-width: 1px 1px 2px 1px;">
			<tr>
				...
				<p style="font-size: 18px;">Hi, <?php echo $model->FullName;?>! So far we have made the following predictions:</p>
				...
				<?php
					$this->widget('PreviousTips', array(
						...
						'free'    => $model->accessViewTips ? PreviousTips::FREE_NULL : PreviousTips::FREE_TRUE,
						'view'    => 'cwebroot.themes.classic.views.PreviousTips.mail', // active / last
					));
				?>
				</td>
			</tr>
			...
			<tr>
				<td style="font-size: 13px;padding: 40px 30px;color: #000;">
					<center>
						...
						<a href="" style="color: #656d78;margin: 0px 20px;"><img align="center" style="margin: 0px 10px 0px 0px;" src="<?php echo Yii::app()->createAbsoluteUrl('/'); ?>/images/mail/hello.png" />Say hello</a>&rarr;
					</center>
					<div style="margin: 20px 0px; border-bottom: 3px solid #e6e9ed;"></div>
					<div style="text-align: center;color: #aab2bd;">Copyright © 2013 BetonFootball, Inc, All rights reserved.<br/>You are receiving this email because you signed up on betonfootball.eu. We hope you love it!</div>
