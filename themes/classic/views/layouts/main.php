...
<div class="menu" style="overflow: visible;">
	...
	<?php $this->widget('zii.widgets.CMenu',array(
		'items'=>array(
			array('label'=>Yii::t('themes', 'Главная'), 'url'=> array('/tip/default/index'), 'linkOptions'=>array('class'=>'home')),
			array('label'=>Yii::t('themes', 'Статистика авторов'), 'url'=> array('/tip/default/tipsters'), 'linkOptions'=>array('class'=>'tipsters')),
			//array('label'=>'Stats', 'url'=> array('#'), 'linkOptions'=>array('class'=>'stats')),
			array('label'=>Yii::t('themes', 'О БОФ'), 'url'=> array('/site/page','view'=>'about'), 'linkOptions'=>array('class'=>'about_bof')),
			array('label'=>Yii::t('themes', 'Подписаться'), 'url'=> array('/tip/default/subscription'), 'linkOptions'=>array('class'=>'subscription')),
			array('label'=>Yii::t('themes', 'Контакты'), 'url'=> array('/guidline/default/contacts'), 'linkOptions'=>array('class'=>'contacts')),
			array('label'=>Yii::t('themes', 'Гайдлайн'), 'url'=> array('/site/page','view'=>'manual'), 'linkOptions'=>array('class'=>'guidline')),
			array('label'=>Yii::t('themes', 'Видео'), 'url'=> array('/guidline/default/video'), 'linkOptions'=>array('class'=>'video')),
...
<div id="footer">
	<div class="site-width">
		<div class="f-top">
			<div class="beton">
				...
				<div class="social">
					...
					<?php echo CHtml::link('Say Hello'.CHtml::image(Yii::app()->theme->baseUrl.'/css/images/footer/arrow_right.png'), array('/guidline/default/contacts'), array('class'=>'sh'));?>
				</div>
			</div>
			<div class="f-menu">
				<ul>
					<li><span class="shoes"><?php echo Yii::t('themes', 'О БОФ'); ?></span></li>
			...
			<div class="f-menu">
				<ul>
					<li><span class="sheld"><?php echo Yii::t('themes', 'ТОЛЬКО С BOF'); ?></span></li>
					<li><?php echo CHtml::link(Yii::t('themes', 'План подписки'),array('/tip/default/subscription')); ?></li>
				</ul>
			</div>
			<div class="f-menu">
				<ul>
					<li><span class="cup"><?php echo Yii::t('themes', 'BETTINGADVICE ПОДТВЕРДИЛ'); ?></span></li>
		...
		<table class="f-bottom">
		    <tr>
		        <td class="f-left"><?php echo Yii::app()->config->get('COPYRIGHT'); /*&copy; 2013 BetOnFootball. All rights reserved.*/?></td>
				<td class="f-mid">
					<?php echo CHtml::link(Yii::t('themes', 'ТЕРМИНЫ &amp; УСЛОВИЯ РАБОТЫ'),array('/site/page','view'=>'terms')); ?>
					<?php echo CHtml::link(Yii::t('themes', 'ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ'),array('/site/page','view'=>'privacy')); ?>
		        ...
		        <td class="f-right">
					<a rel="nofollow" href="http://wakeupstudio.ru/contacts" target="_blank">Design by <span>Wake Up!</span></a>&nbsp;&nbsp;&nbsp;
					<a rel="nofollow" href="http://meway.ru" target="_blank">Developed by <img style="vertical-align: middle" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/meway.png"></a>
				</td>
		    </tr>
		</table>
	</div>
...
<noscript><div><img src="//mc.yandex.ru/watch/23890561" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
