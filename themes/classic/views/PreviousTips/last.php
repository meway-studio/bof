<div class="site-width">
    <div class="last-tips">
        <div class="title">
            ...
            if ($tipster == null) {
                echo CHtml::link(
                    Yii::t( 'tips', 'Смотреть все последние советы' ),
                    Yii::app()->createUrl( '/tip/default/list', array( 'active' => 0 ) ),
                    array( 'class' => 'top' )
                );
            } else {
                echo CHtml::link(
                    Yii::t( 'tips', 'Смотреть все последние советы' ),
                    Yii::app()->createUrl( '/tip/default/list', array( 'active' => 0, 'tipster' => $tipster ) ),
                    array( 'class' => 'top' )
                );
            }
            echo CHtml::link(
                ...
                <tr class="rows">
                    <td class="event">
                        ...
                        <span><?php echo CHtml::link(
                                $data->club_1 . ' vs ' . $data->club_2,
                                array( '/tip/default/view', 'id' => $data->id )
                            ); ?></span>
                    </td>
                    <td class="date"><?php echo $data->format_event_date_only; ?></td>
                    <td class="tipster"><?php echo CHtml::link(
                            $data->tipster->FullName,
                            array( '/tip/default/stat', 'id' => $data->tipster_id )
                        ); ?></td>
                    <td class="selection">
                        <p><?php echo $data->BetOnClub; ?></p>
                        <span><?php echo $data->SelectionNum; ?></span>
                    </td>
                    ...
                    <?php if (Yii::app()->user->isAdmin): ?>
                        <td class="result"><?php echo CHtml::dropDownList(
                                'Tip[tip_result][' . $data->id . ']',
                                $data->tip_result,
                                Tips::resultList(),
                                array( 'class' => 'adminInput' )
                            ); ?></td>
                        <td class="score"><?php echo CHtml::textField(
                                'Tip[match_result][' . $data->id . ']',
                                $data->match_result,
                                array( 'class' => 'adminInput' )
                            ); ?></td>
                    ...
                    <?php else: ?>
                        ...
                        <td class="score">
                            <span class="scoreInput"><?php echo $data->match_result; ?></span>
                        </td>
                    <?php endif; ?>
                </tr>
            <?php endforeach; ?>
