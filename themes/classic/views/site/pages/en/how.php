		...
		<div class="questions">
			...
			<table class="how_to">
				<tr>
					...
					<td>
						<p class="grey_text">
							Sign up on site betonfootball.eu.
						</p>
					</td>
				</tr>
				<tr>
			...
			<table class="how_to" style="margin-left: 75px;">
				<tr>
					...
					<td>
						<p class="grey_text">
							Receive automated distribution on your email at 15:00 on weekdays and at 12:00 on 

weekends (GMT+0), or put a "tick" in your personal account opposite "to receive every new 

prediction on my email».
						</p>
					</td>
				</tr>
				<tr>
