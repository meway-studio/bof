<div class="active-tip">
    ...
    <div class="second-column">
        ...
        <?php echo CHtml::link(
            Yii::t( 'tips', 'Читать совет' ),
            array( 'NbView', 'id' => $data->id ),
        ...
        <center>
            <?php if ($data->accessManage): ?>
                <?php echo CHtml::link(
                    CHtml::tag( 'i', array(), '' ) . Yii::t( 'tips', 'Редактировать' ),
                    array( 'updateNb', 'id' => $data->id ),
                    array( 'class' => 'btn-edit' )
                ); ?>
                <?php echo CHtml::link(
                    CHtml::tag( 'i', array(), '' ) . Yii::t( 'tips', 'Удалить' ),
                    array( 'deleteNb', 'id' => $data->id ),
                    array( 'class' => 'btn-delete', 'confirm' => Yii::t( 'tips', 'Вы серьезно?' ) )
                ); ?>
            <?php endif; ?>
        </center>
        <br/>
