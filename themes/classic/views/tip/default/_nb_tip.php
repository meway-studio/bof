<div class="active-tip">
				...
				<div class="right">
					<?php echo CHtml::link(
						...
						array(
							...
							'addthis:url'         => Yii::app()->createAbsoluteUrl('view', array('id'=>$data->id)),
	...
	<div class="second-column">
		...
		<span class="pay"><?php echo Yii::t('tips', 'Бесплатно');?></span>
		
		<?php echo CHtml::link(Yii::t('tips', 'Читать совет'),array('NbView','id'=>$data->id), array('class'=>'button green'));?>
		<br />
		<center>
			<?php if($data->accessManage):?>
				...
				<?php echo CHtml::link( CHtml::tag('i', array(), '').Yii::t('tips', 'Удалить'), array('deleteNb', 'id'=>$data->id), array('class'=>'btn-delete', 'confirm'=>Yii::t('tips', 'Вы серьезно?')));?>
			<?php endif;?>
		</center>
		<br/>
	</div>
