			...
			<div class="tipster-inf">
				<div class="top">
					...
					<div class="some-inf">
						...
						<span><?php echo Yii::t('themes', 'ROI (Доход)'); ?><span> <?php echo $model->tipster->yield;?>%</span></span>
					</div>
					...
					<div class="some-inf-bottom">
						...
						<a class="tips" href="<?php echo Yii::app()->createUrl('/tip/default/list', array('active'=>0, 'tipster'=>$model->id) );?>">
							<span class="pixel active"></span>
				...
				<div class="bottom">
					<span><?php echo $model->tipster->tips;?><span><?php echo Yii::t('themes', 'Количество советов'); ?></span></span>
					<span><?php echo round($model->tipster->winrate,0);?>%<span><?php echo Yii::t('themes', 'Количество побед'); ?></span></span>
					<span style="margin-right: 0;"><?php echo $model->tipster->odds;?><span><?php echo Yii::t('themes', 'Средний коэффициент'); ?></span></span>
				</div>
			</div>
			<div class="analysis">
					...
					<table cellpadding="5" cellspacing="0">
						<tbody>
							<tr class="name">
								...
								<td><?php echo Yii::t('themes', 'Прибыль'); ?></td>
								<td><?php echo Yii::t('tips', 'Поинт'); ?></td>
...
<div class="site-width" style="text-align:center;margin-bottom:35px;">
	<?php echo CHtml::link(Yii::t('themes', 'Показать еще 7 советов'), array('/tip/default/ajaxmore', 'tipster'=>$model->id), array('class'=>'btn-blue', 'id'=>'show7moretips'));?>
</div>
