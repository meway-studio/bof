<div class="active-tip">
		...
		<div class="information">
			<div class="top">
				...
				<div class="right">
					...
					<?php /*<a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/tw.png"></a> */?>
					<?php /*<a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/fb.png"></a>*/ ?>
				</div>
			</div>
			<div class="center">
	...
	<div class="second-column">
		...
		<?php /*if($data->isFree OR $data->accessView){
		...
		<center>
			<?php if($data->accessManage):?>
				...
				<?php echo CHtml::link( CHtml::tag('i', array(), '').Yii::t('tips', 'Удалить'), array('delete', 'id'=>$data->id), array('class'=>'btn-delete', 'confirm'=>Yii::t('tips', 'Вы серьезно?')));?>
			<?php endif;?>
		</center>
		<br/>
