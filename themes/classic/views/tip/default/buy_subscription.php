...
<div class="basket auth">
	...
	<?php if($status==null):?>
		...
		<center style="color:white;">
			<?php echo CHtml::tag('h3', array('class'=>'price'), Yii::t('tips', 'Итого: {price}&euro; (План подписки: {plan})', array('{price}'=>$price, '{plan}'=>$termDesc)));?>
			...
			<div class="pay_icons" id="pay_icons">
				<ul>
					<li data-id="<?php echo Purchase::PAYMENT_CARD;?>">
						<a><img style="height: 60px;margin-top: 8px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/visa.png" /></a>
						<span ><span>VISA</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
					<li data-id="<?php echo Purchase::PAYMENT_CARD;?>">
						<a><img style="height: 60px;margin-top: 8px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/master.png" /></a>
						<span ><span>MasterCard</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
					<li data-id="<?php echo Purchase::PAYMENT_ROBOKASSA;?>">
						<a><img style="height: 60px;margin-top: 8px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/robo.png" /></a>
						<span ><span>Robokassa</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
					<li data-id="<?php echo Purchase::PAYMENT_YANDEX;?>">
						...
						<span ><span>Yandex money</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
					<li data-id="<?php echo Purchase::PAYMENT_WEBMONEY;?>">
						<a><img style="height: 60px;margin-top: 8px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/webmoney.png" /></a>
						<span ><span>Webmoney</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
					<?php /*
					...
					*/ ?>
					<li data-id="<?php echo Purchase::PAYMENT_PAYPALL;?>">
						<a><img style="height: 60px;margin-top: 8px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/paypal.png" /></a>
						<span ><span>PayPal</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
					<li data-id="<?php echo Purchase::PAYMENT_MAILRU;?>">
						<a><img style="height: 60px;margin-top: 8px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/mail_money.png" /></a>
						<span ><span>Mail.ru money</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
					<li data-id="<?php echo Purchase::PAYMENT_LIQPAY;?>">
						<a><img style="height: 60px;margin-top: 8px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/liqpay.png" /></a>
						<span ><span>Liqpay</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
					<li data-id="<?php echo Purchase::PAYMENT_EDK;?>">
						<a><img style="height: 60px;margin-top: 8px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/edk.png" /></a>
						<span ><span>EDK</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
					<?php /*
					...
					*/ ?>
					<li data-id="<?php echo Purchase::PAYMENT_QIWI;?>">
						...
						<span ><span>QIWI</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>

					<li data-id="<?php echo Purchase::PAYMENT_MB;?>">
						<a><img style="height: 60px;margin-top: 8px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/mb.jpg" /></a>
						<span ><span>Moneybookers</span></span>
						<div><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/tips/won.png"></div>
					</li>
	...
	<?php else:?>
		...
		<h3 style="color: #fff;"><?php echo Yii::t('themes', 'Чтобы подписаться, пожалуйста, переведите деньги на указанные ниже реквизиты.'); ?> <?php /*We apologize for inconvenience, in a month we will connect the united payments processing center to make shopping on our site much easier.*/ ?></h3>
		
		<?php if($model->payment_id == Purchase::PAYMENT_PAYPALL):?>
			<p style="color: #fff;font-size: 34px;"><?php echo Yii::t('themes', 'Наш счет Paypal:'); ?> <?php echo Yii::app()->config->get('ACCOUNT_PAYPALL');?></p>
		<?php elseif($model->payment_id == Purchase::PAYMENT_MB):?>
			<p style="color: #fff;font-size: 34px;"><?php echo Yii::t('themes', 'Наш счет Moneybookers:'); ?> <?php echo Yii::app()->config->get('ACCOUNT_MB');?></p>
		...
		<div class="basket-bottom">
			<?php echo CHtml::link(Yii::t('tips', 'К истории покупок'),array("purchase"),array('class'=>'but-checkout') ); ?>
		</div>
