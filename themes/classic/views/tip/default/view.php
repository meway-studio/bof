	...
	<div class="briks">
		<div class="brik">
			...
			<div class="brik-inf">
				...
				<div class="right">
					...
					<span class="yeld"><?php echo Yii::t('themes', 'Получат'); ?> <span><?php echo $model->tipster->tipster->yield;?>%</span></span>
			...
			<div class="bottom">
				<span><?php echo Yii::t('tips', '{n} <span>Ставка</span>|{n} <span>Ставки</span>|{n} <span>Ставок</span>|{n} <span>Ставок</span>', $model->tipster->tipster->tips); ?></span>
				<span><?php echo $model->tipster->tipster->winrate;?>%<span><?php echo Yii::t('themes', 'Кол. побед'); ?></span></span>
		...
		<div class="brik">
			...
			<div class="brik-inf no-marg">
				<div class="tip-result <?php if($model->tip_result==Tips::TIP_RESULT_WON){echo 'won';}elseif($model->tip_result==Tips::TIP_RESULT_LOST){echo 'lost';}elseif($model->tip_result==Tips::TIP_RESULT_VOID){echo 'void';}?>">
				...
				<div class="profit no-marg">
					...
					<span class="small-info or-bg"><?php 
						echo $model->tip_result==Tips::TIP_RESULT_VOID ? 'unknow' : Yii::t('tips', '{profit} единица', array('{profit}'=>$model->tempProfit));
					?></span>
				</div>
			</div>
		</div>
...
<div class="site-width" style="text-align:center;margin-bottom:35px;">
	<?php echo CHtml::link(Yii::t('themes', 'Показать еще 7 советов'), array('/tip/default/ajaxmore', 'tipster'=>$model->tipster_id), array('class'=>'btn-blue', 'id'=>'show7moretips'));?>
</div>