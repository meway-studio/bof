...
<div class="form">
    ...
    <div class="tip_form_filter">
        ...
        <div style="float:right;">
            <?php echo $form->labelEx( $model, 'bod', array( "class" => "label", 'style' => 'vertical-align: middle;  margin-right: 2px;' ) ); ?>
    ...
    <div style="overflow: hidden;">
        ...
        <div class="tip_form_block" style="margin-left: 20px;">
            ...
            <div class="row">
                ...
                <div class="team_choose"><?php echo $form->radioButtonList(
                        $model,
                        'bet_on',
                        array( 1 => Yii::t( 'tips', 'Команда 1' ), 2 => Yii::t( 'tips', 'Команда 2' ) ),
                        array( 'class' => 'bet_on_ch' )
                    ); ?></div>
                <?php //echo $form->error($model,'bet_on'); ?>
            </div>
            <div class="row tip_detail_partner">
                <label class="required"><?php echo Yii::t( 'themes', 'Букмекер' ); ?>
                    <span class="required">*</span>
                </label>
                <?php echo CHtml::image(
                    Yii::app()->theme->baseUrl . "/css/images/sb.png",
                    "",
                    array( 'data-id' => Tips::BOOKMAKER_SBOBET )
                ); ?>
                <?php echo CHtml::image(
                    Yii::app()->theme->baseUrl . "/css/images/365.png",
                    "",
                    array( 'data-id' => Tips::BOOKMAKER_BET365 )
                ); ?>
                <?php echo CHtml::image(
                    Yii::app()->theme->baseUrl . "/css/images/pin.png",
                    "",
                    array( 'data-id' => Tips::BOOKMAKER_PINNACLE )
                ); ?>
                <?php echo CHtml::image(
                    Yii::app()->theme->baseUrl . "/css/images/betfair.png",
                    "",
                    array( 'data-id' => Tips::BOOKMAKER_BETFAIR )
                ); ?>
    ...
    <div class="tip_form_block" style="width: auto;float: none;overflow: hidden;">
        <div class="tip_form_block_header" style="padding-left: 215px;"><?php echo Yii::t(
                'themes',
    ...
    <div style="overflow: hidden;">
        ...
        <div class="row tip_buttons">
            <p><?php echo Yii::t(
                    'themes',
                    '{s} Внимание! Заполните корректно все полей и ничего не забывайте!',
                    array( '{s}' => '<span style="color: #e9573f;">*</span>' )
                ); ?></p>
            <center>
                <?php echo CHtml::submitButton(
                    Yii::t(
                        'tips',
                        $model->isNewRecord ? Yii::t( 'themes', 'Добавить совет. Даааа!' ) : Yii::t( 'themes', 'Обновить совет' )
                    )
                ); ?>
            </center>
        </div>
