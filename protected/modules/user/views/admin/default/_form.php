...
<p class="help-block"><?php echo Yii::t(
        'user',
...
<?php echo $form->dropDownList(
    ...
    'role',
    $model->roleList,
    array_merge( array( 'class' => 'span5' ), $model->disabledForManager( 'role' ) )
); ?>

<?php if ($model->role == User::ROLE_TIPSTER): ?>
    <?php echo $form->checkBoxRow( $model, 'show_in_statistic', $model->disabledForManager( 'show_in_statistic' ) ); ?>
<?php endif ?>

<?php echo $form->textFieldRow(
    $model,
    'email',
    array_merge( array( 'class' => 'span5', 'maxlength' => 50 ), $model->disabledForManager( 'email' ) )
); ?>
...
<?php echo $form->textFieldRow(
    $model,
    'phone',
    array_merge( array( 'class' => 'span5', 'maxlength' => 20 ), $model->disabledForManager( 'phone' ) )
); ?>

<?php echo $form->textFieldRow(
    $model,
    'firstname',
    array_merge( array( 'class' => 'span5', 'maxlength' => 50 ), $model->disabledForManager( 'firstname' ) )
); ?>
...
<?php if ($model->tipster !== null AND $model->role == User::ROLE_TIPSTER): ?>
    ...
    <?php echo $form->textFieldRow(
        $model->tipster,
        'rank',
        array_merge( array( 'class' => 'span5', 'maxlength' => 250 ), $model->disabledForManager( 'rank' ) )
    ); ?>
    <?php echo $form->textFieldRow(
        $model->tipster,
        'comment',
    ...
    <?php echo $form->textAreaRow(
        $model->tipster,
        'profile',
        array_merge( array( 'rows' => 6, 'cols' => 50, 'class' => 'span8' ), $model->disabledForManager( 'profile' ) )
    ); ?>
...
<?php echo $form->textAreaRow(
    $model,
    'about',
    array_merge( array( 'rows' => 6, 'cols' => 50, 'class' => 'span8' ), $model->disabledForManager( 'about' ) )
); ?>

<?php echo CHtml::link(
    Yii::t( 'User', 'Добавить отзыв' ),
    array( '/user/admin/reviews/addbyuser', 'id' => $model->id ),
    array_merge( array( 'class' => 'btn' ), $model->disabledForManager( 'reviews' ) )
); ?>
