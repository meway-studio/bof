...
<p>
    ...
    $form->dropDownListRow(
        ...
        'tpl_inherit',
        array(
            Yii::t( 'CatalogModule.admin.category.main', 'Нет' ),
            Yii::t( 'CatalogModule.admin.category.main', 'Да' )
        ),
        array( 'class' => 'span5' )
    ); ?>
</p>
...
<p>
    <?php echo $form->labelEx( $model, 'tpl_theme' ); ?>
    <?php echo $form->textField( $model, 'tpl_theme', array( 'class' => 'span5', 'maxlength' => 100 ) ); ?>
</p>

<p>
    <?php echo $form->labelEx( $model, 'tpl_path' ); ?>
    <?php echo $form->textField( $model, 'tpl_path', array( 'class' => 'span5', 'maxlength' => 100 ) ); ?>
</p>

<p>
    <?php echo $form->labelEx( $model, 'tpl_layout' ); ?>
    <?php echo $form->textField( $model, 'tpl_layout', array( 'class' => 'span5', 'maxlength' => 100 ) ); ?>
</p>
...
<p>
    ...
    $form->dropDownListRow(
        $model,
        'active',
        array( Yii::t( 'CatalogModule.admin.category.main', 'Нет' ), Yii::t( 'CatalogModule.admin.category.main', 'Да' ) ),
        array( 'class' => 'span5' )
    ); ?>
</p>
