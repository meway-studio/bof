...
class Purchase extends CActiveRecord
{
    ...
    public function getIsSkrill()
    {
        return $this->payment_id == self::PAYMENT_SKRILL ? true : false;
    }
    ...
    public function getIncCurrLabel()
    {
        switch ($this->payment_id) {
            ...
            CASE self::PAYMENT_CARD      :
                return 'BANKOCEAN2R';
            CASE self::PAYMENT_EASYPAY   :
                return 'EasyPayB';
            CASE self::PAYMENT_RBK       :
                return '';
            CASE self::PAYMENT_MAILRU    :
                return 'MailRuOceanR';
            CASE self::PAYMENT_LIQPAY    :
                return 'LiqPayZ';
            CASE self::PAYMENT_EDK       :
                return 'W1R';
            CASE self::PAYMENT_YANDEX    :
                return 'YandexMerchantR';
            CASE self::PAYMENT_WEBMONEY  :
                return 'WMEM';
            default:
                return '';
        }
