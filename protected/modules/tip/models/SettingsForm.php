...
class SettingsForm extends CFormModel
{
	...
	{
		return array(
			array('SUBSCRIPTION_TITLE, SUBSCRIPTION_TEXT, SUBSCRIPTION_WEEKEND_TEXT, SUBSCRIPTION_WEEKEND_PRICE, SUBSCRIPTION_WEEKEND_PRICE_SAVE, SUBSCRIPTION_MONTH_TEXT, SUBSCRIPTION_MONTH_PRICE, SUBSCRIPTION_MONTH_PRICE_SAVE, SUBSCRIPTION_3MONTH_TEXT, SUBSCRIPTION_3MONTH_PRICE, SUBSCRIPTION_3MONTH_PRICE_SAVE, SUBSCRIPTION_SEASON_TEXT, SUBSCRIPTION_SEASON_PRICE, SUBSCRIPTION_SEASON_PRICE_SAVE, TRACK_RECORD_TITLE, TRACK_RECORD_TEXT, TRACK_RECORD_YEAR, TRACK_RECORD_TIPSTERS, TRACK_RECORD_TIPS_GIVER, TRACK_RECORD_TIPS_COME, TRACK_RECORD_MEMBERS, SITENAME, COPYRIGHT, FOOTER_TEXT, DEFAULT_TITLE, DEFAULT_META_K, DEFAULT_META_D, ACCOUNT_TEXT, CONTACT_TITLE, CONTACT_HEADER, CONTACT_TEXT, CONTACT_META_K, CONTACT_META_D, CONTACT_MESSAGE_SUCCESS, CONTACT_MESSAGE_FAILURE, CONTACT_PHONE, CONTACT_EMAIL_1, CONTACT_EMAIL_2, CONTACT_SKYPE, ACCOUNT_QIWI, ACCOUNT_MB, ACCOUNT_PAYPALL', 'safe'),
		);
	}
