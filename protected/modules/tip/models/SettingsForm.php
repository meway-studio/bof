...
class SettingsForm extends CFormModel
{
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'SHOW_COMMENTS'                   => Yii::t( 'settings', 'Отображать комментарии' ),
        );
    }
}