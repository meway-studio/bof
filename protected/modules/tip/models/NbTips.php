...
class NbTips extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			*/
			...
			array('status, event_h, event_m', 'numerical', 'integerOnly'=>true, 'on'=>'create'),
			...
			array('id, status, create_date, update_date, event_date, tipster_id, club_1, flag_1, club_2, flag_2, league, content, cover, meta_k, meta_d', 'safe', 'on'=>'search'),
		);
	}
	...
	public function getPreview(){
		return mb_strlen($this->content)>300 ? mb_substr(strip_tags($this->content), 0, 300, 'UTF-8').'...' : strip_tags($this->content) ;
	}
