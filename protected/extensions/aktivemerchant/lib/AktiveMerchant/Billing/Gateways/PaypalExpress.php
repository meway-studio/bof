...
class PaypalExpress extends PaypalCommon
{
    ...
    private function add_address( $options )
    {
        ...
        $billing_address = isset($options[ 'billing_address' ]) ? $options[ 'billing_address' ] : (array_key_exists(
            'address',
            $options
    ...
    private function map_address( $billing_address )
    {
        ...
        $address->map( 'name', 'PAYMENTREQUEST_0_SHIPTONAME' )->map( 'phone', 'PAYMENTREQUEST_0_SHIPTOPHONENUM' )->map(
            'city',
            'PAYMENTREQUEST_0_SHIPTOCITY'
        )->map( 'address1', 'PAYMENTREQUEST_0_SHIPTOSTREET' )->map( 'address2', 'PAYMENTREQUEST_0_SHIPTOSTREET2' )->map(
            'state',
            'PAYMENTREQUEST_0_SHIPTOSTATE'
        )->map( 'country', 'PAYMENTREQUEST_0_SHIPTOCOUNTRYCODE' )->map( 'zip', 'PAYMENTREQUEST_0_SHIPTOZIP' );
    ...
    {
        $redirect_url = $this->isTest() ? self::TEST_REDIRECT_URL : self::LIVE_REDIRECT_URL;
